  ...
  return (
    <main style={{
      ...
      <nav style={{
        ...
        <img src="/Timedshot-logo.png" alt="Timedshot logo" style={{ height: 44 }} />
      ...
      <footer style={{
        ...
        <img src="/Timedshot-logo.png" alt="Timedshot logo" style={{ height: 32, filter: "brightness(0) invert(1)", opacity: 0.7 }} />
